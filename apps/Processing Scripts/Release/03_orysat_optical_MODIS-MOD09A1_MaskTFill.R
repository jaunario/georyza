...
if(USE_MODISLC) {
  ...
  mdata.lc <- modis.readHDF(dir(MODIS_HOME, pattern=paste(paste0("MCD12Q1.A",ifelse(YEAR==yearFromDate(Sys.Date()),YEAR-1,YEAR),"001.",TILE),"hdf",sep=".*."), recursive = TRUE, full.names = TRUE))
